...
return(
  <>
  <CourseHeader props={"Frequently Asked Questions"} name={"FAQ"}></CourseHeader>
  
    <div style={{width:"70%",margin:"0 auto"}}>

         <Accordion defaultActiveKey="0" >
      <Accordion.Item eventKey="0">
        <Accordion.Header><h4 className="text-blue-900 font-bold text-center">What is Alpha Math?</h4></Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="1">
        <Accordion.Header><h4  className="text-blue-900 font-bold text-center">What is our mission?</h4></Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="3">
        <Accordion.Header><h4  className="text-blue-900 font-bold text-center">Why should i use Alpha Math?</h4></Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="4">
        <Accordion.Header><h4  className="text-blue-900 font-bold text-center">Who are the creators of Alpha Math?</h4></Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="5">
        <Accordion.Header><h4  className="text-blue-900 font-bold text-center">Who can use Alpha Math?</h4></Accordion.Header>
        <Accordion.Body>
